# This python code is used to migrate data from azure blob container to an AWS s3 bucket
# run this file with this command : python3 <file_name.py>
...
# Copy each blob from Azure Blob Storage to AWS S3
for blob in blobs:
    blob_name = blob.name
    s3_object_key = os.path.join("prefix_in_s3_bucket", blob_name)  # Set the destination S3 object key as needed
